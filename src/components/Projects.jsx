...
const CardsData = [
    {
      ...
      desc: " Developed and deployed using HTML, TailwindCSS and REACTJS Designed and prototyped using Figma and Photoshop. ",
      link: "https://www.figma.com/design/rPZUNPF4s8jZI2hbv4ezeB/Untitled?node-id=0-1&p=f&t=Z89eg6Dao1Ck4mYi-0"
    ...
    },
    {
      ...
      desc: "Designed and Prototyped using Figma and Photoshop ",
    ...
    },
    {
        id: 4,
        img: Card3,
        title: "Java GUI School Project",
        desc: "GUI Integration: Utilizes Java Swing or JavaFX. Includes input validation and error messages to handle invalid or missing data effectively.",
         link: "https://github.com/keycee78/Java-GUI/tree/master/src/bmicalcu"
      },
  ];
  ...
  const Projects = () => {
    return (
      ...
      <h1 className="text-center text-[#252525] font-bold text-4xl sm:text-5xl md:text-6xl mb-5 sm:mt-10 pt-10 ml-4 sm:ml-7 md:text-left">
  Recent Projects
</h1>
            ...
            return (
              ...
              >
                <img
                  src={img}
                  alt=""
                  className="w-full max-w-[350px] h-[500px] rounded-lg"
                />
  
                <div className="absolute bottom-0 left-0 w-full h-2/3 
                                bg-gradient-to-t from-black/80 to-transparent 
                                opacity-0 group-hover:opacity-100 transition-all duration-500 p-4">
                  <div className="flex flex-col items-start text-left space-y-2 absolute bottom-4 left-4 w-full">
                    <Slide cascade>
                      <Fade cascade damping={0.05}>
                        <p className="text-sm max-w-[300px] break-words">
                          {desc}
                        </p>
                      </Fade>
